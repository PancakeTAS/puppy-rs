/// \file cache.h This file manages a cache file for each and every api endpoints
 ...
 * \param endpoint
 *   The endpoint to grab the file from
 * \return
 *   0 if the file was grabbed successfully, 1 otherwise
*/
 ...
 *   List of endpoints
 * \return
 *   0 if the file was written successfully, 1 otherwise.
*/
